  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-md px-4 py-10 sm:py-16">
        <h1 className="mb-1 font-display text-2xl font-bold tracking-tight text-ink">Join with a code</h1>
        ...
        >
          ...
          {loading && <p className="font-mono text-xs text-ink/50">Looking up the code…</p>}
